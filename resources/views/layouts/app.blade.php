        ...
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
            <div class="flex min-w-0 items-center gap-3 sm:gap-8">
                ...
                <nav class="flex items-center gap-0.5 overflow-x-auto text-sm sm:gap-1">
                    ...
                    <a href="{{ route('laporan-komisi.index') }}"
                       class="whitespace-nowrap rounded-md px-2 py-2 sm:px-3 {{ request()->routeIs('laporan-komisi.*') ? 'bg-violet-50 text-violet-700 font-medium' : 'text-gray-600 hover:text-gray-900' }}">
                        Laporan Komisi
                    </a>
                </nav>
            </div>
