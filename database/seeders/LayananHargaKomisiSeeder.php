...
class LayananHargaKomisiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $buat = function (string $nama, string $kategori, bool $termasukPotong, array $varianList) {
        ...
        $buat('Gunting Wanita', 'Potong', true, [
            ['varian' => 'default', 'harga_min' => 200000],
        ]);
        $buat('Gunting Pria', 'Potong', true, [
            ['varian' => 'default', 'harga_min' => 150000],
        ]);
        $buat('Gunting Anak', 'Potong', true, [
            ['varian' => 'default', 'harga_min' => 150000],
        ]);
        $buat('Potong Poni', 'Potong', true, [
            ['varian' => 'default', 'harga_min' => 75000],
        ]);

        // ===================== STYLING (KOMISI DIKONFIRMASI) =====================
        $buat('Cuci Catok / Styling + Blow', 'Styling', false, [
        ...
        $buat('Keratin Premium', 'Treatment Rambut', false, [
        ...
        $buat('Smoothing', 'Treatment Rambut', false, [
        ...
        $buat('Basic Color Two Apply', 'Warna Rambut', false, [
        ...
        $buat('Refresh Color Treatment', 'Warna Rambut', false, [
        ...
        $buat('Fashion Color', 'Warna Rambut', false, [
        ...
        $buat('Highlight', 'Warna Rambut', false, [
